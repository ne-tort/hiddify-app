export default {
  ...
  masque: {
    ...
    warpMasquePanelModel: "Panel sing-box only: WARP over MASQUE; Cloudflare enrollment runs on save. Not included in member subscriptions.",
    authModes: "Auth type",
    authBearer: "Bearer",
    authBasic: "Basic",
    authMtls: "mTLS",
    tabServer: "Server",
    tabClient: "Client",
    subscriptionAuthModes: "Credentials in subscription",
