export default {
  ...
  objects: {
    ...
    dial: "Dial",
    tls: "TLS",
    l3router_peer: "L3 peer",
    multiplex: "Multiplex",
    transport: "Transport",
    headers: "Headers",
    key: "Key",
    value: "Value",
    geo_catalog: "Geo Catalog",
    routing_profile: "Routing Profile",
    awg_obfuscation_profile: "AmneziaWG obfuscation profile",
  },
  awg: {
    tabConnection: "Connection",
    tabObfuscation: "Obfuscation",
    obfuscationProfiles: "Obfuscation profiles",
    obfuscationParams: "Obfuscation parameters (AmneziaWG 2.0)",
    linkedProfile: "Linked profile (optional)",
    inlineOverrides: "Inline overrides (optional, override profile)",
    autofill: "Autofill (deprecated)",
    nameRequired: "Profile name is required",
    wireguardSection: "Server & peers (WireGuard-compatible)",
    generatorSection: "Generator (AmneziaWG-Architect)",
    generate: "Generate obfuscation fields",
    generateDone: "Obfuscation fields filled",
    boostRegenerate: "Boost & regenerate",
    intensity: "Intensity",
    mimicProfile: "Mimic profile",
    customHost: "Custom host (optional; empty = Architect host pool)",
    mtu: "MTU",
    junkLevel: "Junk-train level",
    mimicAll: "Mimic all",
    routerMode: "Router mode",
    extremeMax: "Extreme maximums",
    browserFp: "Browser fingerprint (packet sizes)",
    browserProfile: "Browser",
    cpsTags: "CPS tags (I-chain)",
    genErr: {
      mtu_range: "MTU must be between 576 and 9000",
      junk_level_range: "Junk level must be 0–15",
    },
  },
  group: {
    parent: "Parent group",
    ...
    deletedPlaceholder: "Deleted group #{id}",
    effectiveMemberCount: "Members (incl. nested)",
  ...
  l3router: {
    ...
    duplicateIP: "IP conflicts with an existing peer",
    invalidPeerIP: "Invalid IPv4 CIDR (e.g. 10.0.0.1/32)",
    autoGroupDesc: "Endpoint clients {name}",
  },
  masque: {
    title: "MASQUE",
    warpMasqueTitle: "WARP MASQUE",
    mode: "Mode",
    serverListen: "Listen address",
    transportMode: "Transport mode",
    templateUdp: "template_udp",
    templateIp: "template_ip",
    templateTcp: "template_tcp",
    httpLayer: "http_layer",
    serverAuthHint: "server_auth (JSON, server only)",
    extHint: "Profile secrets JSON (stored in ext, merged for runtime)",
    profileCompatibility: "profile.compatibility",
    tlsServerName: "tls_server_name",
    clientServerToken: "Client server_token (subscription merge)",
    warpClientServerToken: "WARP MASQUE client server_token",
    tlsCertificate: "TLS certificate",
    warpMasqueAutoRegister: "On first save without consumer keys or Zero Trust credentials, s-ui registers with Cloudflare WARP like legacy Warp and fills profile data for sing-box warp_masque.",
  },
  actions: {
    action: "Action",
    add: "Add",
