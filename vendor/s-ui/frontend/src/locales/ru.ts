export default {
  ...
  masque: {
    ...
    clientBasicUsername: "Basic username",
    clientBasicPassword: "Basic password",
    warpMasquePanelModel: "Только sing-box этой панели: WARP через MASQUE, регистрация у Cloudflare при сохранении. В пользовательские подписки не включается.",
    authModes: "Тип аутентификации",
    authBearer: "Bearer",
    authBasic: "Basic",
    authMtls: "mTLS",
    tabServer: "Сервер",
    tabClient: "Клиент",
    subscriptionAuthModes: "Учётные данные в подписке",
    clientMtlsSpki: "mTLS leaf (SPKI SHA-256)",
  },
  actions: {
    action: "Действие",
    add: "Добавить",
