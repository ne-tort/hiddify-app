export default {
  ...
  pages: {
    ...
    settings: "Настройки",
    routingProfiles: "Профили маршрутизации",
    debug: "Дебаг",
  },
  main: {
    tiles: "Плитки",
  ...
  objects: {
    ...
    dial: "Звонок",
    tls: "TLS",
    l3router_peer: "L3-пир",
    multiplex: "Мультиплекс",
    transport: "Транспорт",
    headers: "Заголовки",
    key: "Ключ",
    value: "Значение",
    geo_catalog: "Гео-каталог",
    routing_profile: "Профиль маршрутизации",
    awg_obfuscation_profile: "Профиль обфускации AmneziaWG",
  },
  awg: {
    tabConnection: "Подключение",
    tabObfuscation: "Обфускация",
    obfuscationProfiles: "Профили обфускации",
    obfuscationParams: "Параметры обфускации (AmneziaWG 2.0)",
    linkedProfile: "Привязанный профиль (необязательно)",
    inlineOverrides: "Переопределения в эндпоинте (необязательно, поверх профиля)",
    autofill: "Автозаполнение (устарело)",
    nameRequired: "Укажите имя профиля",
    wireguardSection: "Сервер и пиры (как в WireGuard)",
    generatorSection: "Генератор (AmneziaWG-Architect)",
    generate: "Сгенерировать параметры",
    generateDone: "Поля обфускации заполнены",
    boostRegenerate: "Усилить и перегенерировать",
    intensity: "Интенсивность",
    mimicProfile: "Профиль мимикрии",
    customHost: "Свой хост (необязательно; пусто — пул Architect)",
    mtu: "MTU",
    junkLevel: "Junk-train (уровень)",
    mimicAll: "Mimic all",
    routerMode: "Режим роутера",
    extremeMax: "Экстремальные максимумы",
    browserFp: "Отпечаток браузера (размеры пакетов)",
    browserProfile: "Браузер",
    cpsTags: "Теги CPS (I-цепочка)",
    genErr: {
      mtu_range: "MTU должен быть 576–9000",
      junk_level_range: "Junk level: 0–15",
    },
  },
  group: {
    parent: "Родительская группа",
    parents: "Родительские группы",
    memberOf: "Входит в группы",
    nestedGroups: "Вложенные группы",
    parentId: "Родитель",
    memberCount: "Участники",
    clientsColumn: "Клиенты",
    deletedPlaceholder: "Удаленная группа #{id}",
    effectiveMemberCount: "Участники (с вложенными)",
    directMemberCount: "Непосредственно",
    members: "Участники группы",
    boundL3: "Группа",
  },
  l3router: {
    groups: "Группы",
    privateSubnet: "Подсеть",
    overlayDestination: "Оверлей",
    packetFilter: "Фильтрация",
    peersJson: "Пиры",
    clients: "Клиенты",
    ...
    duplicateIP: "IP конфликтует с существующим пиром",
    invalidPeerIP: "Некорректный IPv4 CIDR (напр. 10.0.0.1/32)",
    autoGroupDesc: "Клиенты endpoint {name}",
  },
  masque: {
    title: "MASQUE",
    warpMasqueTitle: "WARP MASQUE",
    mode: "Режим",
    serverListen: "Адрес прослушивания",
    transportMode: "Режим транспорта",
    templateUdp: "template_udp",
    templateIp: "template_ip",
    templateTcp: "template_tcp",
    httpLayer: "http_layer",
    serverAuthHint: "server_auth (JSON, только сервер)",
    extHint: "Секреты профиля JSON (в ext, сливаются при runtime)",
    profileCompatibility: "profile.compatibility",
    tlsServerName: "tls_server_name",
    clientServerToken: "Клиентский server_token (подписка)",
    warpClientServerToken: "WARP MASQUE server_token клиента",
    tlsCertificate: "TLS Сертификат",
    warpMasqueAutoRegister: "При первом сохранении без ключей consumer или Zero Trust s-ui выполняет регистрацию WARP как у legacy Warp и заполняет данные профиля для sing-box warp_masque.",
  },
  actions: {
    action: "Действие",
    add: "Добавить",
  ...
  setting: {
    ...
    jsonSubRule: "JSON + Rule",
    jsonSubHapp: "happ",
    jsonSubL3: "JSON (L3Router)",
    jsonSubWG: "JSON (WireGuard)",
    jsonSubMasque: "JSON (MASQUE)",
