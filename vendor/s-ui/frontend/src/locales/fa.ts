export default {
  ...
  l3router: {
    groups: "گروه‌ها",
    privateSubnet: "زیرشبکه",
    overlayDestination: "پوشش",
    packetFilter: "فیلتر",
    peersJson: "همتاها",
    clients: "مشتریان",
    individual: "فردی",
    ...
    peerId: "Peer",
    peerIP: "IP",
    filterSource: "فیلتر مبدأ",
    filterDestination: "فیلتر مقصد",
    duplicateIP: "تداخل IP با همتا",
    autoGroupDesc: "مشتریان endpoint {name}",
  },
  masque: {
    title: "MASQUE",
    ...
    extHint: "Profile secrets JSON (ext, merged at runtime)",
