...
- owner_step_guard_control_plane_trend_age_stability_auto_calibration_window_runs_count: 5
...
- owner_step_guard_control_plane_trend_age_stability_recommendation_confidence_drift_signal_quality_window: unstable
- owner_step_guard_control_plane_trend_age_stability_recommendation_confidence_drift_accounted: no
- owner_step_guard_control_plane_trend_age_stability_recommendation_confidence_drift_reliability_gate_required: 1
- owner_step_guard_control_plane_trend_age_stability_recommendation_confidence_drift_reliability_gate_status: 1
...
- owner_step_guard_control_plane_trend_age_stability_recommendation_confidence_drift_regression_hints: suppressed_by_reliability_gate(signal_quality_window=unstable; requires strict_overlay_delta_status=0 and control_plane_status=0)
