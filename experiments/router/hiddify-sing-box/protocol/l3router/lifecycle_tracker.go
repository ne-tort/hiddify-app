...
func (e *Endpoint) RoutedPacketConnection(ctx context.Context, conn N.PacketConn, _ adapter.InboundContext, _ adapter.Rule, matchOutbound adapter.Outbound) N.PacketConn {
	if !isL3RouterMatch(e, matchOutbound) {
		return conn
	}
	return conn
