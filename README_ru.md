...
**Форк (ne-tort):** исходники клиента — **https://github.com/ne-tort/hiddify-app**. Сабмодуль ядра — **https://github.com/ne-tort/hiddify-core** (см. `.gitmodules`). В этом форке — доработки в т.ч. под **AWG** (парсинг и связанная логика). Сборка: [docs/BUILD.md](docs/BUILD.md).
